...
export const textServices: ServiceDefinition[] = [
  ...
  { stub: 'gpt-5.2', name: 'GPT-5.2', description: 'The best model from OpenAI', provider: 'openai', model: 'gpt-5.2-chat-latest', disabled: true },
  { stub: 'gemini-3-pro', name: 'Gemini 3 Pro', description: 'The best model from Google', provider: 'google', model: 'gemini-3-pro-preview', disabled: true },
];
